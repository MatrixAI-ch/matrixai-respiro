...
async function main() {
    ...
    const imageRespiroAvatar = 'https://matrixai-ch.github.io/matrixai-respiro/respiro_maskot_reduced.png';
    ...
    loadFontAwesome();
    createBubble(imageRespiroAvatar, smartAssistantBubbleData.avatarUrl, smartAssistantBubbleData.bubbleAligment, smartAssistantBubbleData.displayWelcomeMessage ? smartAssistantBubbleData.welcomeMessage : undefined);
...
function hideWelcomeMessage(){
 const welcomeMessage = document.getElementById("welcome-message");
            ...
            // Hide the welcome message after 9 seconds on mobile screens
...
function createBubble(imageRespiroAvatar, imageUrl, position, welcomeMessage) {
    ...
    // Add event listener for the chat bubble image click
    //const chatBubbleImage = document.getElementById("bubble").querySelectorAll("img");
    //chatBubbleImage.addEventListener("click", toggleDisplay);
}
function createSmartAssistantContainer(smartAssistantId, position, accentColor) {
    ...
    // Add event listener for the chat bubble image click
    const smartAssistantContainer = document.getElementById("smart-assistant-container");
    const imgElements = smartAssistantContainer.querySelectorAll("img");
    for (const imgElement of imgElements) {
      // Apply CSS styles or perform actions on the imgElement
