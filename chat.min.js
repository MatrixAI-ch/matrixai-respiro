...
async function main() {
    ...
    const imageRespiroAvatar = '/respiro_maskot_reduced.png';
...
function createBubble(imageRespiroAvatar, imageUrl, position, welcomeMessage) {
    ...
    if (welcomeMessage) {
        const welcomeMessageHTML = `\n      <div id="welcome-message" style="\n        display: block;\n        font-family: Robotto,sans-serif;\n        font-size: 15px;\n        position: fixed;\n        bottom: 80px;\n        ${position}: 20px;\n        padding: 15px 20px;\n        box-shadow: 0px 0px 20px rgba(0, 0, 0, 0.15);\n        border-radius: 15px;\n        max-width: ${window.innerWidth > 350 ? "300px" : "250px"};\n        color: #000000;\n        background-color: #ffffff;\n        word-wrap: break-word;\n   z-index: 100;">\n   <img src="${imageRespiroAvatar}" alt="Smile Image" style="width: 30px; height: 30px; margin: 10px auto;">     ${welcomeMessage}\n      </div>\n    `;
